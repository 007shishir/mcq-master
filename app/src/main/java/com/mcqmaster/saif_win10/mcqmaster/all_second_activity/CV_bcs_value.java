...
public class CV_bcs_value extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("bcs_value");
        ...
        mHeader.setText(getResources().getString(R.string.morality));
            ...
            protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            Intent intent = new Intent(CV_bcs_value.this, StudyMcqV2.class);
                            intent.putExtra("key_name", post_key);
                            intent.putExtra("childName", "bcs_value");
                            Toast.makeText(CV_bcs_value.this, "Please make sure you turn off the rotation of your device", Toast.LENGTH_LONG).show();
