...
public class CV_bng_grammar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("bng_grammar");
        ...
        mHeader.setText(getResources().getString(R.string.bng_grammar));
            ...
            protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            ...
                            Intent intent = new Intent(CV_bng_grammar.this, StudyMcqV2.class);
                            intent.putExtra("key_name", post_key);
                            intent.putExtra("childName", "bng_grammar");
                            Toast.makeText(CV_bng_grammar.this, "Please make sure you turn off the rotation of your device", Toast.LENGTH_LONG).show();
