...
public class CV_bcs_generalS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("general_s");
        ...
        mHeader.setText(getResources().getString(R.string.general_science));
            ...
            protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            Intent intent = new Intent(CV_bcs_generalS.this, StudyMcqV2.class);
                            intent.putExtra("key_name", post_key);
                            intent.putExtra("childName", "general_s");
                            Toast.makeText(CV_bcs_generalS.this, "Please make sure you turn off the rotation of your device", Toast.LENGTH_LONG).show();
