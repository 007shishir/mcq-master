...
public class CV_bcs_mental extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("bcs_mental");
        ...
        mHeader.setText(getResources().getString(R.string.mental));
            ...
            protected void populateViewHolder(ParameterViewHolder viewHolder, Parameter model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            Intent intent = new Intent(CV_bcs_mental.this, StudyMcqV2.class);
                            intent.putExtra("key_name", post_key);
                            intent.putExtra("childName", "bcs_mental");
                            Toast.makeText(CV_bcs_mental.this, "Please make sure you turn off the rotation of your device", Toast.LENGTH_LONG).show();
